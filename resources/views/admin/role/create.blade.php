          ...
          <div class="">
            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                    <h2>Tambah Role <small>Manajemen Role</small></h2>
                    <div class="clearfix"></div>
                  </div>
                  <div class="x_content">
                    <form id="add-role" data-parsley-validate class="form-horizontal form-label-left" method="post" action="{{ route('roles.store') }}">
                        {{ csrf_field() }}
